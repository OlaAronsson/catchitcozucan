...
public class DaProcessStepConstants {
	...
	static final String ANNOT_MAKESTEP_JAVA_PATH = "thehole.black.process.MakeStep";
	static final String ANNOT_PROCESSSTATUS_JAVA_PATH = "thehole.black.process.ProcessStatus";
