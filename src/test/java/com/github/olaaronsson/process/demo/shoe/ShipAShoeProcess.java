...
import com.github.olaaronsson.process.demo.shoe.internal.LaceProvider;
import com.github.olaaronsson.process.demo.shoe.internal.ShoeProvider;
...
public class ShipAShoeProcess extends ProcessBase {
    ...
    ///////CHKSUM: 5750203B1013975B5213DF493D791908XXXXXXXX/////////////////////
    //
    ...
    private final ProcessStep doSendPackageStep = new ProcessStep(){ 
        ...
        public Enum<?> statusUponSuccess() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.SHIPPED;
        }

        @Override
        public Enum<?> statusUponFailure() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.SHIPPING_FAILED;
        }
    ...
    private final ProcessStep doGetShoeStep = new ProcessStep(){ 
        ...
        @Override
        public Enum<?> statusUponSuccess() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.SHOE_FETCHED_FROM_WAREHOUSE;
        }

        @Override
        public Enum<?> statusUponFailure() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.SHOE_NOT_YET_AVAILABLE;
        }
    ...
    private final ProcessStep doGetLacesStep = new ProcessStep(){ 
        ...
        @Override
        public Enum<?> statusUponSuccess() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.LACES_IN_PLACE;
        }

        @Override
        public Enum<?> statusUponFailure() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.LACES_NOT_IN_PLACE;
        }
    ...
    private final ProcessStep doGetPackagingStep = new ProcessStep(){ 
        ...
        @Override
        public Enum<?> statusUponSuccess() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.PACKED;
        }

        @Override
        public Enum<?> statusUponFailure() {
            return com.github.olaaronsson.process.demo.shoe.OrderStatus.Status.PACKAGING_FAILED;
        }
