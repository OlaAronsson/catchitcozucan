...
import static thehole.black.process.impl.source.processor.DaProcessStepConstants.error;
...
import static thehole.black.process.impl.source.processor.DaProcessStepLookup.TMP_COMP_PATH;
...
import thehole.black.process.internal.util.MD5Digest;
import thehole.black.process.internal.util.io.IO;
import thehole.black.process.util.ClassAnnotationUtil;
import thehole.black.process.util.MavenWriter;

@SupportedAnnotationTypes({ "thehole.black.process.MakeStep" })
