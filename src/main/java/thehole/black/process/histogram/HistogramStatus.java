...
public class HistogramStatus implements Comparable<HistogramStatus> {
	...
	private final Map<String, Integer> errorOccurences;

	public HistogramStatus(String nameOfHistogram, Map<String, Integer> sortedInEnum, String failureStatusRegExp, Map<String, Integer> errorOccurences) {
		this(nameOfHistogram, sortedInEnum, errorOccurences);
	...
	public HistogramStatus(String nameOfHistogram, Map<String, Integer> sortedInEnum, String failureStatusRegExp) {
		this(nameOfHistogram, sortedInEnum, new HashMap<>());
		this.failureStatusRegExp = failureStatusRegExp;
	}

	public HistogramStatus(String nameOfHistogram, Map<String, Integer> sortedInEnum, Map<String, Integer> errorOccurences) {
		...
		this.errorOccurences = errorOccurences;
	}
